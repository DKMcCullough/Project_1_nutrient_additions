...
plt.scatter(x = df_0['times'], y = [avg_0], color = 'purple', label = '0 NH4 added')
plt.scatter(x = df_40['times'], y = [avg_40], color = 'blue',  label = '40 NH4 added')
plt.scatter(x = df_400['times'], y = [avg_400],  color = 'green' , label = '400 NH4 added')
plt.scatter(x = df_4000['times'], y = [avg_4000], color = 'yellow' ,  label = '4000 NH4 added')
plt.scatter(x = df_40000['times'], y = [avg_40000], color = 'orange', label = '40000 NH4 added')
plt.scatter(x = df_400000['times'], y = [avg_400000],color = 'red',  label = '400000 NH4 added')

plt.errorbar(df_0['times'], avg_0, yerr=yerr_0,fmt='none', color = 'purple')
plt.errorbar(df_40['times'], avg_40, yerr=yerr_40,fmt='none', color = 'blue')
plt.errorbar(df_400['times'], avg_400,yerr=yerr_400,fmt='none', color = 'green' )
plt.errorbar(df_4000['times'], avg_4000, yerr=yerr_4000,fmt='none', color = 'yellow' )
plt.errorbar(df_40000['times'], avg_40000, yerr=yerr_40000,fmt='none', color = 'orange')
plt.errorbar(df_400000['times'], avg_400000, yerr=yerr_400000,fmt='none', color = 'red' )
